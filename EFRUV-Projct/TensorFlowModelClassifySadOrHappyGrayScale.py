...
def plotResults(train_a, test_a, train_c, test_c):
    ...
    plt.grid(True)
    #plt.show()
    plt.savefig('accuracy_grayscale.png')
    plt.clf()
    ...
    plt.grid(True)
    #plt.show()
    plt.savefig('loss_grayscale.png')
...
def main(argv=None):
    ...
    batchSize = 25
    trainingSetFiles, trainingLabels, testingSet, testingLabels = createDataSets("AMFED/AMFED/happinessGray/","AMFED/AMFED/nonHappinessGray/",dataSetSize,testingSplit)
